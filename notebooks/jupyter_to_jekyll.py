...
print("absolute dir",output_abs_dir)

basedir = os.path.abspath(os.path.join(output_abs_dir, "..", ".."))
...
base_file_name: str = re.sub(r'^\d{4}\-\d{2}\-\d{2}\-', '', 
                             base_file_name_with_date_prefix) # 'YYYY-MM-DD-post-name' => 'post-name'
...
print("IIIIIIIIIIIIIIIII",output_markdown_abs_path)
